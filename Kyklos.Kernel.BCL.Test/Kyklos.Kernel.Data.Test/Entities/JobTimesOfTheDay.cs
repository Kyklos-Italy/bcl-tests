...
namespace Kyklos.Kernel.Data.Test.Entities
{
    ...
    {
        [EntityPropertyInfo(ColumnName = "hours", DbType = PropertyDbType.Integer, IsNullable = true, ColumnOrder = 10)]
        ...
        {
            var result = obj as JobTimesOfTheDay;
            return result != null &&
                   Hours == result.Hours &&
                   Job == result.Job &&
                   Dateofwork == result.Dateofwork &&
                   JobId == result.JobId &&
